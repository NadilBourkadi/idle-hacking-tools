# Candidate and Craft Status — 1 August 2026
...
- **Slippery Driver of Striking is decompile-LOCKED as of 3 Aug** — approved craft base (`driver-ab-2026-08-03` pre-declared; contract in decision-log). On equip, **Aegisbound Driver of Cataclysm becomes the live revert lock** until the A/B closes.
- Revert paths: **no live locks as of 1 Aug** — Citadel Shell of the Phoenix released when `shell-ab-2026-07-31` closed KEEP (its tier observations persist in the capture archive; decompile freely). Everything else released as of 31 Jul evening: Resilient Firewall of Perpetuity and Bastioned Payload (their A/Bs closed KEEP), the two Aligned items and Warmongering Driver (27–28 Jul A/Bs long closed; the Warmongering lock line was simply stale), and all older spent alternates. Inventory pressure arrived (91/102) and the 31 Jul clear-out actioned it — see decision-log.
