...
RESERVED_PROBES = [
    ...
    },
    {
        ...
        "unblock": "RUN 12 Aug 2026, and it answered the BIAS question, not "
                   "the SIZE one: 7 runs/arm in Data Center, ZERO censored, "
                   "Barrier 2,794 -> 896 at identical Regen, beta = 0.070 "
                   "+- 0.114. Unbiased, and ABOVE the ceiling the censored "
                   "fit claimed, so PENDING_REFITS closed. Still open is "
                   "PRECISION -- that interval spans zero to 1.5x Regen "
                   "parity and distinguishes neither. The arms stay held: "
                   "the size question needs the same instrument with a "
                   "BIGGER lever, nearer the original -49 score than the "
                   "-10.4 owned today. Superseded text follows. "
                   "A CI/CD pair on the purest owned Barrier lever, read as "
